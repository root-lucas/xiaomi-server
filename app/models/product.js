...
class ProductMtl {
    // 连接数据库,分页获取所有的商品信息
    async MGetAllProduct(offset = 0, rows = 0) {
    ...
    async MGetProductByCategory(categoryID, offset = 0, rows = 0) {
    ...
    // 连接数据库根据商品分类名称获取分类id
    async MGetCategoryId(categoryName) {
